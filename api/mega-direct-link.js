module.exports = async (req, res) => {
    ...
    try {
        // Accept POST body or GET query for easier testing
        const rawBody = req.body
        const parsedBody = typeof rawBody === 'string' ? safeJsonParse(rawBody) : rawBody
        const url = (parsedBody && parsedBody.url) || (req.query && req.query.url)
